...
public class ComidasAlimentoRepository {
    ...
    public List<Comida_Alimento> getComidasAlimento(String comida,int dia,int mes,int anio){return getComidasAlimentoPrivate(comida,dia,mes,anio);}
    ...
    private List<Comida_Alimento> getComidasAlimentoPrivate(String comida,int dia,int mes,int anio){return dao.getComidasAlimento(comida,dia,mes,anio);}
